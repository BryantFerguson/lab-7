...
public class ScoreWord {
	...
	private int CalculateWordScore() {
		...
		for(int i = 0; i < tiles.size(); i++) {
			if (board.getPuzzle()[tiles.get(i).getRow()][tiles.get(i).getCol()].getBonusSquare() == null 
			|| board.getPuzzle()[tiles.get(i).getRow()][tiles.get(i).getCol()].getBonusSquare().isUsed()) {
				iTotalScore = tiles.get(i).getLetter().getiScore();
			}
			
			else if (board.getPuzzle()[tiles.get(i).getRow()][tiles.get(i).getCol()].getBonusSquare().getBonusType() 
					== eBonusType.DoubleLetter) {
				iTotalScore = tiles.get(i).getLetter().getiScore() * 2;
			}
			
			else if (board.getPuzzle()[tiles.get(i).getRow()][tiles.get(i).getCol()].getBonusSquare().getBonusType() 
					== eBonusType.TripleLetter) {
				iTotalScore = tiles.get(i).getLetter().getiScore() * 3;
			}
		...
		for(int i = 0; i < tiles.size(); i++) {
			if ((board.getPuzzle()[tiles.get(i).getRow()][tiles.get(i).getCol()].getBonusSquare() != null)
					&& (board.getPuzzle()[tiles.get(i).getRow()][tiles.get(i).getCol()].getBonusSquare().isUsed() == false)
					&& (board.getPuzzle()[tiles.get(i).getRow()][tiles.get(i).getCol()].getBonusSquare().getBonusType() == eBonusType.DoubleLetter)) {
				
			}
			
			else if ((board.getPuzzle()[tiles.get(i).getRow()][tiles.get(i).getCol()].getBonusSquare() != null)
					&& (board.getPuzzle()[tiles.get(i).getRow()][tiles.get(i).getCol()].getBonusSquare().isUsed() == false)
					&& (board.getPuzzle()[tiles.get(i).getRow()][tiles.get(i).getCol()].getBonusSquare().getBonusType() == eBonusType.TripleLetter)) {
